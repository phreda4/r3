...
|; gSYS Linux x64 - convension System V AMD64 ABI
|; registros: rdi, rsi, rdx, rcx, r8, r9, luego stack
|; sin shadow space (a diferencia de Windows)
|; stack r3: rax=TOS, [rbp]=NOS, [rbp-8]=NNOS, etc.
|; preA16/posA16 = alineacion de stack a 16 bytes
...
| SYS7: ( a b c d e f g adr -- result )
| rdi=a rsi=b rdx=c rcx=d r8=e r9=f [rsp]=g
:gSYS7
    preA16
    "sub rsp,16" ,ln
    "mov r10,[rbp]" ,ln
...
| SYS8: ( a b c d e f g h adr -- result )
| rdi=a rsi=b rdx=c rcx=d r8=e r9=f [rsp]=g [rsp+8]=h
:gSYS8
    preA16
    "sub rsp,16" ,ln
    "mov r10,[rbp]" ,ln
...
| SYS9: ( a b c d e f g h i adr -- result )
| rdi=a rsi=b rdx=c rcx=d r8=e r9=f [rsp]=g [rsp+8]=h [rsp+16]=i
:gSYS9
    preA16
    "sub rsp,32" ,ln
    "mov r10,[rbp]" ,ln
...
| SYS10: ( a b c d e f g h i j adr -- result )
| rdi=a rsi=b rdx=c rcx=d r8=e r9=f [rsp]=g [rsp+8]=h [rsp+16]=i [rsp+24]=j
:gSYS10
    preA16
    "sub rsp,32" ,ln
    "mov r10,[rbp]" ,ln
