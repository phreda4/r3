...
|====================== OPT
| 
| DUP $3F >> -  |  ajuste de signo a 
|	"bt #0,63;adc #0,0"   
| CTZ		
|	"tzcnt rax, rdi"
|	"mov rcx,64;bsf @0,#0;cmovz @0,#0" 
| CLZ
|	"lzcnt rax,rdi"
| MSB
|	"lzcnt rax,rdi;xor rax,63"
| MIN
|	"cmp rax,rdi;cmovg rax,rdi"
| MAX
|	"cmp rax,rdi;cmovl rax,rdi"
| ABS
|	"cqo;xor rax,rdx;sub rax, rdx"
|	"mov rcx,rax;neg rax;cmovl rax,rcx"

| ++N* | const+reg+reg*(1|2|4|8) @ !
|
|====================== test..
| #0 #1 ... TOS NOS
| ejecucion..
...
|-----------------------------------------
#vmc
gdec ghex gwor gdwor gvar gdvar gstr 
